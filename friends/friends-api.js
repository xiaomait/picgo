...
function friend_api() {
  ...
  let ask = function (token = '') {
    ...
    var introduction = document.getElementById(
      'qexo_friend_brief introduction'
    ).value
    ...
    if (!name || !website || !logo) {
      document.getElementById('qexo-friend-btn').style.backgroundColor =
        '#f5365c'
